...
/**
 * runBlocking => Block execution thread
 * GlobalScope.launch() / launch() => local or global blocking, no need to specify delay manually
 * async - await => Use if you want multiple concurrent operations to calculate a single result
 * withContext() => Multiple different operations to calculate different result
 **/
